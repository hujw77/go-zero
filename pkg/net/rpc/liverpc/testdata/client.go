...
// If you want to change this file, Please see README in git.atmatrix.org/k12/zero/app/tool/liverpc/protoc-gen-liverpc/
package testdata

import (
	"git.atmatrix.org/k12/zero/pkg/net/rpc/liverpc"
	"git.atmatrix.org/k12/zero/pkg/net/rpc/liverpc/testdata/v1"
	"git.atmatrix.org/k12/zero/pkg/net/rpc/liverpc/testdata/v2"
)
