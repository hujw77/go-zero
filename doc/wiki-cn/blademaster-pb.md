...
使用`RegisterDemoBMServer`示例代码请参考[kratos-demo内的http](https://github.com/HuJingwei/go-zero-demo/blob/master/internal/server/http/server.go)内的如下代码：
...
`internal/service`内的`Service`结构实现了`DemoBMServer`接口可参考[kratos-demo内的service](https://github.com/HuJingwei/go-zero-demo/blob/master/internal/service/service.go)内的如下代码：
