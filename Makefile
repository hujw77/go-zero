...
kratos:
	$(GORUN) build/ci.go install ./app/tool/kratos
	@echo "Done building."
	@echo "Run \"$(GOBIN)/kratos\" to launch."

kratos-protoc:
	$(GORUN) build/ci.go install ./app/tool/kratos-protoc
	@echo "Done building."
	@echo "Run \"$(GOBIN)/kratos-protoc\" to launch."

kratos-gen-bts:
	$(GORUN) build/ci.go install ./app/tool/kratos-gen-bts
	@echo "Done building."
	@echo "Run \"$(GOBIN)/kratos-gen-bts\" to launch."

kratos-gen-mc:
	$(GORUN) build/ci.go install ./app/tool/kratos-gen-mc
	@echo "Done building."
	@echo "Run \"$(GOBIN)/kratos-gen-mc\" to launch."

kratos-gen-project:
	$(GORUN) build/ci.go install ./app/tool/kratos-gen-project
	@echo "Done building."
	@echo "Run \"$(GOBIN)/kratos-gen-project\" to launch."

protoc-gen-bm:
	$(GORUN) build/ci.go install ./app/tool/protobuf/protoc-gen-bm
	@echo "Done building."
	@echo "Run \"$(GOBIN)/protoc-gen-bm\" to launch."

protoc-gen-bswagger:
	$(GORUN) build/ci.go install ./app/tool/protobuf/protoc-gen-bswagger
	@echo "Done building."
	@echo "Run \"$(GOBIN)/protoc-gen-bswagger\" to launch."

protoc-gen-ecode:
	$(GORUN) build/ci.go install ./app/tool/protobuf/protoc-gen-ecode
	@echo "Done building."
...
testgen:
	$(GORUN) build/ci.go install ./app/tool/kratos/testgen
	@echo "Done building."
	@echo "Run \"$(GOBIN)/testgen\" to launch."

testcli:
	$(GORUN) build/ci.go install ./app/tool/kratos/testcli
	@echo "Done building."
	@echo "Run \"$(GOBIN)/testcli\" to launch."

admin-bbq-comment:
	$(GORUN) build/ci.go install ./app/admin/bbq/comment/cmd
	@echo "Done building."
